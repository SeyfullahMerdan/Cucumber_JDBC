...
public class DBUtillStepDefinitions {
    ...
    public void kullanici_db_util_ile_sutunundaki_verileri_okur(String fields) throws SQLException {
    ...
    public void db_util_ile_tum_degerlerini_sira_numarasi_ile_yazdirir(String field) throws Exception {
        ...
        for (int i=1 ; i<satirSayisi ; i++) {
            System.out.println( siraNo + " .inci satırdaki price: " + DBUtils.getResultset().getString(field));
